...
//                    Toast.makeText(context, "No items has been added in your cart", Toast.LENGTH_SHORT).show();
//                }
                    Toast.makeText(context, "added to yourcart"+getListCart(), Toast.LENGTH_SHORT).show();
